  ...
  if (isError) {
    return (
      <Alert
        ...
        description={(error as any)?.message || 'Không thể lấy thông tin tài khoản.'}
        type="error"
        showIcon
        ...
        <Col xs={24} md={12}>
          <Card bordered={false} className="shadow-sm hover:shadow-md transition-shadow h-full">
            <Statistic
              ...
              precision={2} // Hiển thị 2 chữ số thập phân
        ...
        <Col xs={24} md={12}>
          <Card bordered={false} className="shadow-sm hover:shadow-md transition-shadow h-full">
            <Statistic
              ...
              // Tắt hiệu ứng format số (dấu phẩy) cho số tài khoản
              groupSeparator="" 
            />
          </Card>
        </Col>
